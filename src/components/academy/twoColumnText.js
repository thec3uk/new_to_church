...
const HexModal = ({ content, setModalOpen, colourClasses }) => (
  ...
  >
    <div>
      <div>
        <svg className={`fill-current ${colourClasses} absolute right-0 mr-8 cursor-pointer`} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" onClick={() => setModalOpen(false)}>
